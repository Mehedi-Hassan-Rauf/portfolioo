...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} flex flex-col gap-10 min-h-screen relative max-w-screen justify-center items-center dark:bg-black bg-black bg-grid-white/[0.12]`}
